<div class="container">
    ...
    <form  wire:submit.prevent="updateBook" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="form-group">
                <label for="new_cover" class="label-control">Cover</label>
                <input type="file" name="new_cover" id="new_cover" class="form-control" wire:model="new_cover">
                @if($new_cover)
                <img src="{{$new_cover->temporaryUrl()}}" width="120" alt="">
                @else
                <img src="{{asset('storage/app/images/books/covers')}}/{{$cover}}" width="120" alt="">
                @endif
            </div>
            <div class="form-group">
